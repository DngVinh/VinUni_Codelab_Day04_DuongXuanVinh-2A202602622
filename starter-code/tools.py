...
TOOL_DEFINITIONS = [
    {
        ...
        "description": "Tra cứu sản phẩm/dịch vụ Vingroup (xe điện VinFast, gói du lịch Vinpearl) theo danh mục và giá tối đa.",
        "parameters": {
            "type": "object",
            "properties": {
                "category": {
                ...
                "max_price": {
                    "type": "integer",
                    "description": "Giá tối đa tính bằng VNĐ (tùy chọn)."
                }
            },
            "required": ["category"]
        }
    },
    {
        ...
        "description": "Ghi nhận yêu cầu hỗ trợ kỹ thuật hoặc khiếu nại của khách hàng vào hệ thống.",
        "parameters": {
            "type": "object",
            "properties": {
                "customer_name": {
                    "type": "string",
                    "description": "Họ và tên của khách hàng gửi yêu cầu."
                },
                "issue_description": {
                    "type": "string",
                    "description": "Mô tả chi tiết sự cố hoặc khiếu nại cần xử lý."
                },
                "priority": {
                    "type": "string",
